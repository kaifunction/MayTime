    ...
    <div className="contact-us-page-container">
      ...
      <div className="contact-us-page-button">
        ...
        <p style={{color:'white', letterSpacing:'2px', fontWeight:'450', lineHeight:'25px', width:'700px', marginTop:'60px', marginBottom:'140px'}}>
          ...
          <strong style={{color:'#ff6a00', fontSize:'18px'}}>F</strong>or couples embarking on the beautiful journey of marriage, we offer exquisite wedding photography, both indoor and outdoor. We understand the significance of this special day and are committed to capturing every heartfelt moment, from the intimate glances to the joyous
          celebrations. <br/><br/>
